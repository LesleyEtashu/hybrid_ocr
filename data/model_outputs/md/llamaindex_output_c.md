...
> ”Konceptet är inspirerat av Lego®, vi använder ett intervall på 7 cm i alla komponenter, så att du enkelt kan utforma och montera dem i olika lösningar och oavsett hur du kopplar samman våra produkter får du samma gränsnitt - precis som med Lego® ” 
> – Anders Fogelberg
...
| Totala antalet kunder ackumulerat sedan 2010: | Q1 | Q2 | Q3 | Q4 |
|---|---|---|---|---|
| 1060 | **Mars:** FlexQube Navigator AMR visas upp för första gången på Modex i Atlanta. Erhåller order från Siemens Mobility värd 5 MSEK. FlexQube erhåller fler ordrar från Tesla Gigafactory Berlin. Bolaget erhåller eQart® Line order värd 5 MSEK. | **April:** FlexQube erhåller en uppföljningsorder värd 3,7 MSEK från befintlig kund i Nordamerika. FlexQube Navigator AMR vinner pris på Robotics Innovation Award. **Maj:** L’Oréal beställer eQart® Line från FlexQube värda 2,9 MSEK. **Juni:** Amazon lägger order för ytterligare robotar och vagnar värda 15 MSEK. FlexQube visar nytt rekordkvartal avseende orderingång (54,9 MSEK) och försäljning (56,1 MSEK). | **Juli:** Internationell biltillverkare lägger order värd 5 MSEK. **September:** Order på 8 eQart® Line robotvagnar till befintlig större kund. FlexQube tar första order på eQart® Line till kund i Kina. FlexQube visar nytt rekordkvartal avseende försäljning (56,4 MSEK) och är lönsamma på EBITDA-nivå för första gången sedan bolaget noterades. | **November:** FlexQube erhåller ordrar värda 6,4 MSEK i Mexiko. Flyttar till nytt huvudkontor i Mölndal med dubblerad lokalyta. **December:** FlexQube erhåller robotvagnsorder värd 3 MSEK. FlexQube erhåller ordrar värda 3,6 MSEK till ett rymd- och försvarsbolag. Mårten Frostne utsedd till ny VD på FlexQube. FlexQube redovisar för första gången omsättning över 200 MSEK på ett helår. |
...
## Orderingång och nettoomsättning (MSEK) och Nettoomsättning per region (MSEK)

| År | 2018 | 2019 | 2020 | 2021 | 2022 |
|---|---|---|---|---|---|
| Orderingång (MSEK) | ca 50 | ca 60 | ca 70 | ca 130 | ca 210 |
| Nettoomsättning (MSEK) | ca 10 | ca 20 | ca 30 | ca 60 | ca 90 |

| År | 2018 | 2019 | 2020 | 2021 | 2022 |
|---|---|---|---|---|---|
| Europa (MSEK) | ca 70 | ca 80 | ca 90 | ca 110 | ca 200 |
| Övriga marknader (MSEK) | 0 | 0 | 0 | ca 40 | ca 60 |
...
| **SYFTE** Bygga världsledare i intralogistik |
|---|
| **VISION** Vi flyttar material i varje fabrik och lager i världen | **MISSION** Vi existerar för att göra kunder världsledande i internlogistik |
| **KÄRNVÄRDEN** * Mod * Kundfokus * Förtroende * Branschledande | **STRATEGISKA OMRÅDEN** * Stärka arbetet med befintliga kunder * Accelerera robotförsäljningen * Öka effektivitet i operations * Lönsamhet och kassaflödesoptimering * Utveckla personal och företagskultur * Service och eftermarknad |
...
Vi erbjuder modulbaserade och standardiserade byggblock för att skapa framtidssäkrade och hållbara interna logistiklösningar. Tillsammans med våra kunskapsdatabas, skräddarsydda lösningar och omfattande Solutions Library™ skapar vi bästa möjligheter att göra våra kunder världsledande inom intern logistik.
...
| Stärka arbetet med befintliga kunder | Accelerera robotförsäljningen |
|---|---|
| Öka effektivitet i operations | Lönsamhet & kassaflödesoptimering |
| Utveckla personal och företagskultur | Service & eftermarknad |

## Vår resa fortsätter…

| 01 **Mekanisk fas** 2010–2017 | 02 **Transformationsfas** 2018–2020 | 03 **Robotteknikfas** 2021–2026 |
|---|---|---|
...
| Tillverkning av kommersiella fordon såsom lastbilar, bussar och tåg | Tillverkning av bilar | Underleverantörer till bilindustrin |
|---|---|---|
| Tillverkning av anläggnings- och industrimaskiner | Tillverkning av vindkraftverk och andra energirelaterade produkter | Tillverkning av försvarmaterial |
| Tillverkning av vitvaror och elektronik | Lager och distribution av varor | Tillverkning av medicinsk utrustning |
...
<div style="text-align:center; font-size: 48px; color: #f47920; font-weight: 600;">96</div> 
*Antal nya kunder 2022:*

### Orderingång (MSEK)

| KVARTAL | Q1 Q2 Q3 Q4 Q1 Q2 Q3 Q4 Q1 Q2 Q3 Q4 Q1 Q2 Q3 Q4 Q1 Q2 Q3 Q4 | ÅR |
|---|---|---|
| Värde (MSEK) | 10 | 12 | 15 | 18 | 20 | 22 | 23 | 25 | 20 | 22 | 25 | 30 | 28 | 35 | 40 | 50 | 45 | 40 | 38 | 35 | 2018-2022 |
...
* Vagnsystem 
 _Mekaniska vagnar och LiftRunner tågvagnslösningar._

* AGV-system 
 _eQart® Line._

* AMR-system 
 _FlexQube Navigator AMR._
...
| Various car icons stacked vertically | 
| ----------------------------------------------------- |
...
### 1. Flexibel montering 
Bar chart icon

### 2. Antal komponenter ökar kraftigt 
Gears and chart icon

### 3. Komponentbehandling 
Hand and steering wheel icon
...
| Globe, group of people, wifi signal | 
| ------------------------------------------------------------------ | 
| VÄRLDEN | 
| MÄNNISKOR | 
| TEKNOLOGI | 
...
| 1. | Vagnssystem | 2. | AGV / AMR-system | 3. | Flexibilitet |
|---|---|---|---|---|---|
|  | (Behov av material) |  | (Transport) |  |  |
...
* Massanpassning (left side arrow pointing upward) 
* Ständig förändring (right side)

---

*Page footer text (not part of main content):* 
...
* **FlexQube Navigator AMR** 
 _Standardiserad robot för att navigera motoriserade lastbärare._ 
* **FlexQubePLAY Coupling** 
 _Smart och standardiserat interface mellan robot och motoriserad lastbärare._ 
* **FlexQube load carriers** 
 _Motoriserad lastbärare konfigurerad för att transportera specifikt material för ett ”user case” i fabriken, t.ex. flytta säten, hjul eller instrumentbrädor._
...
| 1. Funktion | 2. Storlek | 3. Förvaring |
|---|---|---|
| Flat bed carrier Roller carrier Lift table carrier Cart lift carrier Towing carrier Cobot carrier | min 840 mm max 2500 mm | Flow rack Platform Shelf Kit cart |
...
| 4. Vikt | 5. Rörelse |
|---|---|
| [Icon of weight scale] | Differential drive Front Differential drive Center Omni wheel |

---

Kärnvärdena för AMR-systemet är en viktig grundsten som sammanfattar värdegrunden för systemet samt är drivkraften för nya utvecklingmöjligheter. De etablerade kärnvärden för systemet är baserat på fyra pelare: Smart, Säker, Skalbar och Successful.
...
Bild på automatisk transportlösning med blå och svarta kärl på en robotplattform i lagermiljö.

Bild på person som använder surfplatta vid robot.

Bild på person som lastar kartonger på vagn i lager.

Bild på Signify-logotyp och robotlösning i lager.
...
Sedan 2020 har antalet distrubutörer växt. Vi säljer FlexQubes koncept genom totalt 16 internationella distributörer i 9 olika länder. 
...
Bolagets aktie är noterad på Nasdaq Stockholm First North under symbolen FLEXQ sedan 14 december 2017. FlexQube hade en omsättning under perioden 1 januari till 31 december 2022 om 1,2 miljoner aktier. Detta gav en genomsnittlig omsättning på ca 4 768 aktier per börsdag till ett värde av 290 534 SEK. 
Snittkurs för aktien under perioden var ca 61,7 SEK. Senaste avslut vid periodens slut var 54,8 SEK, innebärande en uppgång om ca 83 procent från teckningskursen i samband med noteringen den 14 december 2017, eller en nedgång om ca 31 procent från stängningskursen den 31 december 2021.
...
Aktierna i FlexQube är inte, och har inte varit, föremål för erbjudande till följd av budplikt, inlösenrätt eller lösningsskyldighet. Aktierna har heller inte varit föremål för något offentligt uppköpserbjudande. 
...
| År | Händelse | Antal aktier (T) Förändring | Antal aktier (T) Totalt | Aktiekapital (TSEK) Förändring | Aktiekapital (TSEK) Totalt |
|---|---|---|---|---|---|
...
## Geografiska platser och kontor
...
Omsättningstillgångar exklusive lager plus outnyttjad del av checkräkningskredit i procent av kortfristiga skulder.

**Rörelsekapital i procent av nettoomsättningen:** 
Totala omsättningstillgångar minus kortfristiga skulder i förhållande till nettoomsättning i procent.
...
|  | 2022 | 2021 |  | 2022 | 2021 |
|---|---|---|---|---|---|
| **NETTOOMSÄTTNINGENS FÖRDELNING, KONCERNEN** | **PERSONAL (fortsättning)** |
| Sverige | 8 543 | 3 426 | LÖNER, ERSÄTTNINGAR M.M. TILL ANSTÄLLDA, DOTTERBOLAG |  |  |
| Europa | 47 670 | 32 216 | Anders Fogelberg (VD)* | 1 579 | 1 226 |
| Nordamerika | 113 033 | 58 018 | Övriga ledande befattningshavare (7) | 6 843 | 4 882 |
| U.K | 6 738 | 2 054 | Övriga anställda | 30 612 | 19 235 |
| Övriga världen | 28 610 | 16 916 | **Summa löner, ersättningar m.m. till anställda** | **39 034** | **25 343** |
| **Summa nettoomsättningens fördelning, koncernen** | **204 594** | **112 630** | Totala sociala avgifter | 6 554 | 3 842 |
...
|  | 2022 | 2021 |  | 2022 | 2021 |
|---|---|---|---|---|---|
| **ÖVRIGA RÖRELSEINTÄKTER, KONCERNEN** | **Not 5 ERSÄTTNING TILL REVISORERNA** |
| Övriga intäkter | 263 | 140 | **ERSÄTTNING TILL REVISORER, KONCERNEN** |  |  |
| Erhållna bidrag* | 163 | 57 | Revision, PwC | 350 | 250 |
| Kursvinst rörelsen (netto) | 3 073 | 483 | Andra uppdrag, PwC | 70 | 58 |
| **Summa övriga rörelseintäkter, koncernen** | **3 499** | **680** | Skatterådgivning, PwC | - | - |
| **ÖVRIGA RÖRELSEINTÄKTER, MODERBOLAG** | **Summa ersättning till revisorer, koncernen** | **420** | **308** |
| Kursvinst på fordringar hos koncernföretag | 3 865 | 1 797 |  |  |  |
| **Summa övriga rörelseintäkter, moderbolag** | **3 865** | **1 797** | **ERSÄTTNING TILL REVISORER, MODERBOLAG** |  |  |
...
|  | 2022 | 2021 |  |  |  |
|---|---|---|---|---|---|
| **MEDELANTAL ANSTÄLLDA I KONCERNEN** |  |  | **Not 6 AVSKRIVNINGAR** |  |  |
| Medelantalet anställda har varit följande: | 60 | 39 | Avskrivningar av immateriella anläggningstillgångar uppgår i koncernen till 3,3 MSEK (3,6). Avskrivningar av materiella |  |  |
| -Varav kvinnor | 15 | 9 | anläggningstillgångar uppgår i koncernen till 1,5 MSEK (1). Inga avskrivningar har genomförts i |  |  |
| Inhyrd personal | 12 | 30 | moderbolaget. |  |  |
...
| Not 7 | ÖVRIGA RÖRELSEKOSTNADER | 2022 | 2021 | Not 10 | INKOMSTSKATT | 2022 | 2021 |
|---|---|---|---|---|---|---|---|
|  | ÖVRIGA RÖRELSEKOSTNADER, KONCERNEN |  |  |  | INKOMSTSKATT, KONCERNEN |  |  |
|  | Kursförlust rörelsen (netto) | - | 136 |  | Aktuell skatt | -71 | -26 |
|  | Summa övriga rörelsekostnader, koncernen | - | 136 |  | Uppskjuten skatt | - | - |
|  | ÖVRIGA RÖRELSEKOSTNADER, MODERBOLAGET |  |  |  | Skatt på årets resultat, koncernen | -71 | -26 |
|  | Kursförlust rörelsen (netto) | - | - |  | Redovisat resultat före skatt | -6 997 | -22 533 |
|  | Summa övriga rörelsekostnader, moderbolaget | - | - |  | Skatt beräknad enligt gällande skattesats | 1 441 | 4 642 |
| Not 8 | BOKSLUTSDISPOSITIONER | 2022 | 2021 |  | Effekt av ej avdragsgilla kostnader | -76 | -15 |
|  | BOKSLUTSDISPOSITIONER, MODERBOLAG |  |  |  | Under året uttnyttjande av tidigare års underskottsavdrag vars skattevärde ej redovisats som tillgång | 888 | 272 |
|  | Lämnade koncernbidrag | 3 400 | 1 797 |  | Ökning av underskottsavdrag utan motsvarande aktivering av uppskjuten skatt | -2 254 | -4 899 |
|  | Summa bokslutsdispositioner, moderbolag | 3 400 | 1 797 |  | Effekt av utländska skattesatser | -71 | -26 |
|  |  |  |  |  | Redovisad skattekostnad | -71 | -26 |
| Not 9 | RÄNTEINTÄKTER OCH RÄNTEKOSTNADER | 2022 | 2021 |  |  |  |  |
|  | RÄNTEINTÄKTER OCH RÄNTEKOSTNADER, KONCERNEN |  |  | INKOMSTSKATT, MODERBOLAGET |  |  |  |
|  | Ränteintäkter | 24 | - | Aktuell skatt | - | - |  |
|  | Summa ränteintäkter, koncernen | 24 | - | Uppskjuten skatt | - | - |  |
|  | Räntekostnader | 656 | 538 | Skatt på årets resultat, moderbolaget | - | - |  |
|  | Summa räntekostnader, koncernen | 656 | 538 | Redovisat resultat före skatt | 59 | 1 312 |  |
|  | RÄNTEINTÄKTER OCH RÄNTEKOSTNADER, MODERBOLAGET |  |  | Skatt beräknad enligt gällande skattesats | -12 | -270 |  |
|  | Ränteintäkter | 2 505 | 1 389 | Effekt av ej avdragsgilla kostnader | -3 | -2 |  |
|  | Summa ränteintäkter, moderbolaget | 2 505 | 1 389 | Under året uttnyttjande av tidigare års underskottsavdrag vars skattevärde ej redovisats som tillgång | 15 | 272 |  |
|  | Varav koncerninterna ränteintäkter | 2 505 | 1 389 | Redovisad skattekostnad | - | - |  |
|  |  |  |  |  |  |  |  |
...
| Not 11 | IMMATERIELLA TILLGÅNGAR, KONCERNEN | 2022 | 2021 | Not 12 | MATERIELLA ANLÄGGNINGSTILLGÅNGAR, KONCERNEN | 2022 | 2021 |
|---|---|---|---|---|---|---|---|
| **BALANSERADE UTGIFTER FÖR UTVECKLINGSARBETEN** | **MASKINER OCH ANDRA TEKNISKA ANLÄGGNINGAR** |
|  | Ingående anskaffningsvärden | 17 207 | 15 290 |  | Ingående anskaffningsvärden | 2 426 | 1 702 |
|  | Årets anskaffningsvärde | 5 343 | 1 917 |  | Årets anskaffningsvärde | 548 | 642 |
|  | Utrangeringar | -11 | - |  | Utrangeringar | -109 | - |
|  | Utgående ack. anskaffningsvärden | 22 540 | 17 207 |  | Omräkningsdifferens | 17 | 82 |
|  |  |  |  |  | Utgående ack. anskaffningsvärden | 2 882 | 2 426 |
|  | Ingående avskrivningar | -5 223 | -2 657 |  | Ingående avskrivningar | -536 | -313 |
|  | Årets avskrivningar | -2 664 | -2 566 |  | Årets avskrivningar | -597 | -223 |
|  | Utrangeringar | 11 | - |  | Utrangeringar | 109 | - |
|  | Utgående ack. avskrivningar | -7 876 | -5 223 |  | Omräkningsdifferens | 443 | - |
|  | Utgående bokfört värde | 14 664 | 11 985 |  | Utgående ack.avskrivningar | -581 | -536 |
|  |  |  |  |  | Utgående bokfört värde | 2 301 | 1 890 |
| **ÖVRIGA IMMATERIELLA RÄTTIGHETER** |  |
|  | Ingående anskaffningsvärden | 2 268 | 2 268 | 2,1 (1,6) MSEK av posten hänför sig till anläggningstillgångar avseende tjänstebilar som har tagits upp i koncernens balansräkning som följd av finansiell leasing. |
|  | Utrangeringar | -2 268 | - |
...
| Not 22 | STÄLLDA SÄKERHETER | 2022 | 2021 | Not 26 | FÖRSLAG TILL VINSTDISPOSITION | 2022 |
|---|---|---|---|---|---|---|
| STÄLLDA SÄKERHETER, KONCERNEN | FÖLJANDE MEDEL STÅR TILL MODERBOLAGETS FÖRFOGANDE (SEK): |
|  | Företagsinteckningar | 12 300 | 12 300 |  | Balanserad vinst | 2 793 |
|  | Aktier i dotterföretag | 226 | 234 |  | Överkursfond | 144 979 |
|  |  | Årets resultat | 59 |
| STÄLLDA SÄKERHETER, MODERBOLAG |  | Summa följande medel står till moderbolagets förfogande | 147 831 |
|  | Företagsinteckningar | 12 300 | 12 300 |  | STYRELSEN FÖRESLÅR ATT |  |
|  | Pantsatta aktier i dotterföretag | 285 | 285 |  | I ny räkning balanseras | 147 831 |
...
> FlexQube har ingått ett nytt kreditfacilitetsavtal med Danske Bank A/S och ALMI om totalt 45 MSEK. 5 MSEK avser långfristigt lån och 40 MSEK tillgängliggörs via en löpande checkkredit. De nya faciliteterna skall primärt användas för att finansiera ett löpande behov av ökat rörelsekapital vid lanseringen av bolagets nya automationsprodukt FlexQube Navigator AMR under 2023. 
> Vid extra bolagsstämma beslutades bland annat om nytt incitamentsprogram för kommande VD i bolaget. Bolagets kommande VD tecknar 110 000 teckningsoptioner vilket tillförde bolaget c:a 1,5 MSEK.
...
Vårt team av maskin- och mekatronikingenjörer fokuserar på en av våra viktigaste strategiska riktningar: 
Bli ett erkänt robotföretag, till stöd för att ta itu med nuvarande megatrender. Vi designar med produktens livscykel i åtanke och vi fortsätter att göra förbättringar för att säkra kvaliteten och effektiviteten. Vi investerar i ny teknik för att skapa en snabbare och säkrare produkt för våra kunder.
...
Bild på en person i blå pikétröja som går i en industrilokal med en robotvagn framför sig.
...
|  |  |
|---|---|
| [x] Kvalitet och leveransprestanda | [x] Mänskliga rättigheter |
| [x] Miljöaspekter | [x] Utvärderingsmetod |
| [x] Hälsa och säkerhet | [x] Affärsetik |
...
Vi fortsätter att vara fast beslutna att minska våra koldioxidutsläpp både i absoluta tal och i förhållande till försäljningen, genom hela vår värdekedja. Under 2021 identifierade vi tre scopes. 
- Scope 1: inkommande transporter för produktion, 
- Scope 2: utgående transporter till kunder och 
- Scope 3: under användning av sålda produkter, med fokus på våra eQarts som drivs av litiumjonbatterier. 

Vi har fortsatt dialogen med våra transportörer för att öka användningen av koldioxideffektiva transportsätt och minska onödiga transporter.

Under det senaste året har vi fortsatt att utveckla vårt FlexQube modulkoncept, som gör det möjligt att skicka vagnar som "platta paket" för att monteras på plats. Vårt patenterade koncept, där allt bultas ihop, innebär att utrustningen till de nya anläggningarna kan levereras omonterat för att sedan monteras på plats hos kunden. Detta minskar behovet av transporter med 70 procent, vilket resulterar i en kraftigt minskad miljöpåverkan. Även om vi har gjort vissa framsteg är vi medvetna om att vi fortfarande är i början av vår resa och att det finns mycket mer att göra. Vi fortsätter att kartlägga var vi kan ha en påverkan och med hur mycket vi skulle minska våra koldioxidutsläpp. Vi kommer kontinuerligt att fortsätta att söka efter nya och innovativa lösningar för att minska vår miljöpåverkan.

### Elförbrukning

Under 2022 bytte vi lokaler i Sverige. Elförbrukningen i den tidigare lokalen var totalt 53 503 kWh under perioden mätt januari-september, i genomsnitt 5 945 kWh per månad. Under perioden augusti-december 2022 hade vi en förbrukning på totalt 33 772 kWh, i genomsnitt 6 754 kWh per månad. Vi kommer att fortsätta mäta vår elförbrukning som numera täcker hela verksamheten i Sverige för att kunna följa utvecklingen och ta fram tillförlitliga KPI:er.
...
| Utsläpp |
|---|
| **190 MWh** Total förbrukning under 2022 | Väg & hav: 99% Flyg: &lt;1% | **70%** |
| Behov av transporter |

</td>
</tr>
<tr>
<td><strong>1,2 %</strong><br>var farligt avfall 2022<br>(2% under 2021)</td>
<td colspan="2"><strong>27 ton</strong><br>Avfall skickat för återvinning från vår montering i Sverige</td>
</tr>
</tbody>
</table>
...
| **35** Medelålder 2022 | **36** Medelålder 2021 |
|---|---|

|  | 2022 | 2021 |
|---|---|---|
| **Alla** | Kvinnor | Män | Kvinnor | Män |
|  | 26% | 74% | 25% | 75% |
| **Ledning** | Kvinnor | Män | Kvinnor | Män |
|  | 29% | 71% | 17% | 83% |
| **Styrelse** | Kvinnor | Män | Kvinnor | Män |
|  | 0% | 100% | 0% | 100% |
...
| Arbetskraft per region | Arbetskraft per region |
|---|---|
| 2022 |  | 2021 |  |
| USA | 47% | Sverige | 46% |
| Sverige | 40% | USA | 42% |
...
Genom att snabbt ta tillvara feedbacken och verkställa förbättringar avslutade vi året med ett mycket positivt resultat som tyder på att förtroendet för ledningen är starkt och att framtiden ser ljus ut.
...
| **MEDARBETARE** |
|---|
| Leverans till återköp | **Vår mission: Vi existerar för att göra våra kunder världsledande i internlogistik.** | Produkt till marknad |
| Beställning till leverans | Försäljning till beställningar |
...
|---|---|
| **Kunder** | Vi söker kundfeedback genom kontinuerlig dialog, produktutbildning, distributörsmöten och uppföljningar samt olika kundundersökningar i syfte att förbättra våra produkter och processer. |
...
| **Samhällen** | Vi försöker påverka de lokala samhällen där våra anläggningar ligger positivt. |
...
Tiger Rod Car, Mummy Car, Short Torque Car, Tool Cart, Kitt Cart - 840 x 3640 mm, Windshield Car - 970 x 1400 mm, Bumper Kit Cart - 980 x 2710 mm, Table Trolley - 840 x 1260 mm, Mother Cart 2 in 1 - 1190 x 1470 mm, Tugger Kit Cart - 840 x 1610 mm. Bolagsstyrning 06
...
För varje dag som går förstärks vår tro på vår på första robotprodukt, eQart® Line. Erbjudandet och problemen den löser på ett unikt, enkelt och kostnadseffektivt sätt är bättre än vad vi hade hoppats på och eQart® Line, tillsammans med FlexQube Navigator AMR, kommer utgöra ett stort fokus för oss kommande åren.
...
| FEBRUARI | APRIL/MAJ |
|---|---|
| Styrelsen Bokslutskommuniké Årsredovisning Förslag till utdelning Förberedelse inför årsstämman | Styrelsen Bolagsstyrningsrapport Styrelseutvärdering Rapportering från revisor Utvärdering revisorer Revisionsplan |
| MARS | APRIL Kvartalsrapport första kvartalet Revisionsplan Utvärdering av incitamentsprogram och behov av nya program att framläggas på årstämma MAJ |
|  | Konstituerande styrelsemöte Styrelsens och utskottens arbetsordningar, VD-instruktioner Ledamöter till revisions- respektive ersättningsutskott Ersättningsutskott Övergripande löneoch villkorspolicy för koncernen Ersättning till ledande befattningshavare, inklusive förslag till riktlinjer för beslut på årsstämma |
...
|---|---|---|
| Styrelsen Budget och affärsmål Bolagsstyrning Uppföljning och utvärdering av styrelsens arbete Ersättningsutskott Utvärdering av VD:s arbete och ledningsgrupp samt planering för framtida behov | Styrelsen Kvartalsrapport tredje kvartalet Strategisk utveckling, utvärdering, strategisk inriktning och mål Revisionsutskott Revisionsplanering bokslut Utvärdering av internkontroll och riskhantering | Styrelsen Kvartalsrapport andra kvartalet |
...
**Innehav i bolaget** 
Per Augustsson innehar, genom bolag, 1 458 443 aktier i bolaget samt 7 000 teckningsoptioner.
...
**Utbildning** 
Magisterexamen i arbetvetenskap från Göteborgs Universitet.
...
**Utbildning** 
Magisterexamen redovisning från Handelshögskolan vid Göteborgs universitet.

**Bakgrund** 
Mikael har lång erfarenhet från finansiella positioner och har tidigare arbetat som CFO för Gigant AB och Grunda AB inom B&B TOOLS (publ)-koncernen. Efter detta jobbade Mikael som head of finance på Centiro Solutions AB innan han anslöt till FlexQube.
...
**Bakgrund** 
Todd har en mångsidig bakgrund inom automotiv verkstads- och driftshantering, försäljning av intäktsgenerering, produktionskapacitet, ekonomisk ansvarighet och affärsplanering.
...
Samtliga styrelseledamöter och ledande befattninshavare i FlexQube kan nås via adressen till FlexQubes huvudkontor, Neongatan 8, 431 53, Mölndal, Sverige.
